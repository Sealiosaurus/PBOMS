...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `seller` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
	<form action="" id="supplier-form">
		...
		<div class="form-group">
			...
			<textarea name="location" id="location" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($location) ? $location : ''; ?></textarea>
		</div>
