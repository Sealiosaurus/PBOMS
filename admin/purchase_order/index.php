<div class="card card-outline card-red">
	<div class="card-header">
        ...
        <div class="card-tools">
			<a href="<?php echo base_url ?>admin/?page=purchase_order/manage_po" class="btn btn-flat btn-danger"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <?php if($row['status'] == 0): ?>
                                        ...
                                        <a class="dropdown-item" href="<?php echo base_url.'admin?page=receiving/manage_receiving&po_id='.$row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-hands text-dark"></span> Receive</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure you want to delete this order?","delete_po",[$(this).attr('data-id')])
		})
