<?php 
$qry = $conn->query("SELECT b.*,s.name as seller,p.po_code FROM back_order_list b inner join seller s on b.seller_id = s.id inner join purchase_order_list p on b.po_id = p.id  where b.id = '{$_GET['id']}'");
if($qry->num_rows >0){
...
<div class="card card-outline card-red">
    <div class="card-header">
        <h1>Back Order Details - <?php echo $bo_code ?></h1>
    </div>
        ...
        <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                    $total = 0;
                    $qry = $conn->query("SELECT b.*,i.name,i.description FROM `bo_items` b inner join product i on b.item_id = i.id where b.bo_id = '{$id}'");
