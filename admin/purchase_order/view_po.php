...
<div class="card card-outline card-danger">
    <div class="card-header">
        <h1>Purchase Order Details - <?php echo $po_code ?></h1>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-danger" href="<?php echo base_url.'/admin?page=purchase_order/manage_po&id='.(isset($id) ? $id : '') ?>">Edit</a>
