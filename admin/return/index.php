<div class="card card-outline card-danger">
	<div class="card-header">
        ...
        <div class="card-tools">
			<a href="<?php echo base_url ?>admin/?page=return/manage_return" class="btn btn-flat btn-danger"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT r.*, s.name as seller FROM `return_list` r inner join seller s on r.seller_id = s.id order by r.`date_created` desc");
