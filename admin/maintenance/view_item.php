...
<?php 
 $qry = $conn->query("SELECT i.*,s.name as seller FROM `product` i inner join seller s on i.seller_id = s.id where  i.id = '{$_GET['id']}' ");
 if($qry->num_rows > 0){
            ...
            <fieldset class="w-100">
                <div class="col-12">
                    ...
                    <dl>
                        ...
                        <dt class="text-info">Seller:</dt>
                        <dd class="pl-3"><?php echo isset($seller) ? $seller : '' ?></dd>
