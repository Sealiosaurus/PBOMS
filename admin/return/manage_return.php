...
<div class="card card-outline card-danger">
    <div class="card-header">
        <h1><?php echo isset($id) ? "Return Details - ".$return_code : 'Create New Return Record' ?></h1>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-danger" type="submit" form="return-form">Save</button>
